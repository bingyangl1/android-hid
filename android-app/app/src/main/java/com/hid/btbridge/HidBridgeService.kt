...
class HidBridgeService : Service() {
    ...
    override fun onCreate() {
        ...
        wakeLock = (getSystemService(POWER_SERVICE) as PowerManager)
            .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "hidbridge:wakelock")
            .apply { acquire() }
    ...
    companion object {
        ...
        const val CMD_UPDATE = "com.hid.btbridge.CMD_UPDATE"
        const val STATUS_UPDATE = "com.hid.btbridge.STATUS_UPDATE"
    }
}
